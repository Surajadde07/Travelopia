...
const Romantic = () => {
    ...
    useEffect(() => {
        const fetchTours = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/routes/romantic`);
    ...
    return (
        <div className="w-screen h-screen">
            ...
            {/* Tour Cards Section */}
            <div className="px-6 py-10 bg-gradient-to-r from-[#f48fb1] to-[#c2185b]">
                <h2 className="text-4xl font-bold text-center text-white mb-10">Romantic Getaways Just for You</h2>
